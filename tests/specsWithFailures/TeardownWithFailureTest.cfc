<cfcomponent extends="testbox.system.compat.framework.TestCase">
	...
	<cffunction
		...
		returntype="void"
		access    ="public"
		hint      ="put things here that you want to run before each test"
	>
	...
	<cffunction
		...
		returntype="void"
		access    ="public"
		hint      ="put things here that you want to run after each test"
	>
	...
	<cffunction
		...
		returntype="void"
		access    ="public"
		hint      ="put things here that you want to run before all tests"
	>
	...
	<cffunction
		...
		returntype="void"
		access    ="public"
		hint      ="put things here that you want to run after all tests"
	>
