...
component extends="testbox.system.BaseSpec" {
	...
	any function injectProperty(
		...
		// Mock it baby
		getMockBox()
			.prepareMock( arguments.receiver )
			.$property(
	 ...
	 */
	function assertEqualsCase(
		required any expected,
		required any actual,
		message = ""
	){
		this.$assert.isEqualWithCase(
			arguments.expected,
			arguments.actual,
			arguments.message
		);
	 ...
	 */
	function assertStructEquals(
		required struct expected,
	 ...
	 */
	function assertIsTypeOf(
		required actual,
		required typeName,
		message = ""
	){
		this.$assert.instanceOf(
			arguments.actual,
			arguments.typeName,
			arguments.message
		);
