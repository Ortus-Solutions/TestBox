...
<cfset Test = createObject("component","testbox.test.resources.Test")>
...
<cfset Test = createObject("component","testbox.test.resources.Test")>
<cfset mockCollaborator = MockBox.createMock(className="testbox.test.resources.Collaborator",callLogging=true)>
