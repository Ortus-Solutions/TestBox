<cfcomponent extends="testbox.system.BaseSpec" displayname="MockBox Suite">
	...
	<cfscript>
		...
		function setup(){
			test = getMockBox().createEmptyMock( "testbox.test.resources.Test" );
		}

		function testMockRealMethods(){
			Test = getMockBox().createMock( "testbox.test.resources.Test" );
			test.getData();
		...
		function testSpys(){
			Test = createObject( "component", "testbox.test.resources.Test" );
		...
		function testCollaborator(){
			Test = createObject( "component", "testbox.test.resources.Test" );
			mockCollaborator = getMockBox().createMock( className="testbox.test.resources.Collaborator",
		                                             callLogging=true );
		...
		function testContainsCFKeyword(){
			test = getMockBox().createMock("testbox.test.resources.Test");
			mockTest = getMockBox().createEmptyMock( "testbox.test.resources.ContainsTest" )
				.$("contains", true);
		...
		function testInterfaceContracts(){
			mock = getMockBox().createMock( "testbox.test.resources.MyInterfaceMock" );
